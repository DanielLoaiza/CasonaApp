...
public abstract class BaseActivity extends AppCompatActivity {
     ...
     *
     * @return {@link com.dafelo.co.casona.internal.di.components.ApplicationComponent}
     */
    protected ApplicationComponent getApplicationComponent() {
        return ((Casona) getApplication()).getApplicationComponent();
    }

    /**
     * Get an Activity module for dependency injection.
     *
     * @return {@link com.dafelo.co.casona.internal.di.modules.ActivityModule}
     */
